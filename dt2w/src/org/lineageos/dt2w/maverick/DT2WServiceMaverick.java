package org.lineageos.dt2w.maverick;
...
public class DT2WServiceMaverick extends Service {
    private static final String TAG = "DT2WServiceMaverick";
    ...
    private class CustomSettingsObserver extends ContentObserver {
        ...
        void update() {
            ...
            SystemProperties.set("persist.sys.maverick.dt2w", dt2wEnabled ? "1" : "0");
        }
